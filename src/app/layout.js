...
export const metadata = {
  ...
  description:
    "Find verified expert tutors for O-Levels, A-Levels, IGCSE and IB. Get matched in under 24 hours. Free consultation: +971 50 446 3928.",
  manifest: "/manifest.ts",
  themeColor: "#0a4d7c",
  keywords:
    "online tutor, O-level tutor, A-level tutor, IGCSE tutor, IB tutor, SAT tutor, tutoring UAE, tutoring UK, TuTurns",
  openGraph: {
    title: "TuTurns | Expert O-Level, A-Level & IGCSE Tutors",
    description:
